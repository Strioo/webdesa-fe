                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-stretch">
                    ...
                    >
                        ...
                        >
                            ...
                            <Link href="/profile">
                                <motion.button
                                    className="inline-flex items-center whitespace-nowrap bg-white/10 backdrop-blur-md text-white font-medium ps-4 pe-2 py-2 mt-5 rounded-full gap-3 cursor-pointer will-change-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent border border-white/20"
