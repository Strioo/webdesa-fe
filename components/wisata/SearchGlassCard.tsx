...
export default function SearchGlassCard({ onAIRecommend }: SearchGlassCardProps) {
  ...
  return (
    ...
    >
      {/* ENHANCED: Better contrast + responsive padding */}
      <div className="rounded-2xl backdrop-blur-xl bg-neutral-900/70 ring-1 ring-white/25 shadow-2xl p-5 sm:p-6 lg:p-7 xl:p-8">
        ...
        <form onSubmit={handleRegularSearch} className="space-y-3 sm:space-y-4">
          {/* Location Field */}
          <motion.div
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 sm:py-3 rounded-full backdrop-blur-sm bg-white/15 border border-white/30 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white focus:bg-white/20 transition-all min-h-[44px] text-sm sm:text-base" 
              />
            </div>
          </motion.div>
          ...
          >
            <label htmlFor="numPeople" className="block text-sm font-medium text-white mb-2">
              Jumlah Pengunjung
            </label>
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 sm:py-3.5 bg-gradient-to-r from-[#5B903A] to-[#4a7a2f] text-white font-semibold rounded-full hover:shadow-lg hover:shadow-[#5B903A]/50 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-900 min-h-[44px] flex items-center justify-center gap-2 text-sm sm:text-base"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
